...
I covered in tests all service layer. Also I covered with tests "DB" layer, where is written logic to work with database.
For testing I use "Junit" like it writtnen in task description, but in extra I was using  "powermock" for "mock" static methods and have ability to cover all "service" and "db" package methods.
